    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
            seedColor: const Color(0xff004953), brightness: Brightness.dark),
        useMaterial3: true,
      ),
      ...
      body: Center(
        child: Column(
          ...
          children: [
            SizedBox(
              width: 200,
              child: Image.asset('assets/jalen.png')
                  .animate()
                  .slideY(begin: -1.5)
                  .shake(),
            )
                .animate(target: widget.numToDisplay.toDouble() == 17 ? 1 : 0)
                .shake(),
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    const Text(
                      'The birds have won this many games:',
                    ),
                    Text(
                      '${widget.numToDisplay}',
